...
/// `native/fancad_dwg/fancad_dwg.h`), so these bindings are written by hand
...
@DefaultAsset('package:fancad_dwg/src/ffi/bindings.dart')
library;

import 'dart:ffi';

/// Status codes, mirroring `FC_STATUS_*` in `fancad_dwg.h`.
class FcStatus {
  const FcStatus._();
