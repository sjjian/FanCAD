...
import '../state/assistant_chat.dart';
import '../state/assistant_profile.dart';
...
class _AiPanelState extends State<AiPanel> {
  ...
  void _syncDraft() {
    ...
    _input.value = TextEditingValue(
      ...
      selection: TextSelection.collapsed(offset: widget.controller.draft.length),
    );
  }
  ...
  Widget build(BuildContext context) {
    ...
    final showCaret = assistantPanelShowsCaret(
      busy: busy,
      messages: messages,
    );
    final canSend =
