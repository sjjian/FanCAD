...
class DxfReader {
    ...
    for (final entry in blockEntities.entries) {
      ...
      document.putBlock(
        BlockRecord(
          ...
          isLayoutBlock:
              entry.key.toUpperCase().contains('MODEL_SPACE') ||
  ...
  static CadEntity? _decode(String type, List<(int, String)> pairs, int id) {
    ...
    switch (type) {
      ...
      case 'POINT':
        return PointEntity(id: id, props: props, position: Vec2(n(10), n(20)));
      case 'LWPOLYLINE':
      ...
      case 'MINSERT':
        ...
        return InsertEntity(
          ...
          columnCount: type == 'MINSERT' ? int.tryParse(v[70] ?? '1') ?? 1 : 1,
          rowCount: type == 'MINSERT' ? int.tryParse(v[71] ?? '1') ?? 1 : 1,
      ...
      case '3DFACE':
        return SolidEntity(
          id: id,
          props: props,
          corners: [xy(10, 20), xy(11, 21), xy(12, 22), xy(13, 23)],
        );
      case 'RAY':
        return RayEntity(
          id: id,
      ...
      case 'MULTILEADER':
        ...
        return MLeaderEntity(
          ...
          content: v[1] ?? '',
          textPosition: Vec2(
            n(11, vertices[vertices.length - 2]),
            n(21, vertices.last),
          ),
