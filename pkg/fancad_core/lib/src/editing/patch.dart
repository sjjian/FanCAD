...
final class AddEntityPatch extends Patch {
  ...
  @override
  Patch inverse(CadDocument document) =>
      RemoveEntityPatch(entity: entity, blockName: blockName, index: index);
...
final class RemoveEntityPatch extends Patch {
  ...
  @override
  Patch inverse(CadDocument document) =>
      AddEntityPatch(entity: entity, blockName: blockName, index: index);
...
final class PutLineTypePatch extends Patch {
  ...
  @override
  Patch inverse(CadDocument document) =>
      PutLineTypePatch(previous ?? LineTypeDef(name: lineType.name), lineType);
...
final class RemoveBlockPatch extends Patch {
  ...
  DocumentChange applyTo(CadDocument document) {
    ...
    return DocumentChange(removed: previous.entityIds, structureChanged: true);
  }

  @override
  Patch inverse(CadDocument document) => RestoreBlockPatch(previous, entities);
