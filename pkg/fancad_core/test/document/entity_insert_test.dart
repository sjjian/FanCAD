...
void main() {
  ...
  test('an insert grip stays on the insertion', () {
    ...
    expect(insert.withGrip(0, const Vec2(4, 5)).position, const Vec2(4, 5));
  });
  ...
  test('an insert draws the attribute value, not the attdef default', () {
    ...
    document
        .entity(document.attdefsOf('TITLE').single.id)!
        .emit(const EmitContext(tolerance: 0.1), definition);
