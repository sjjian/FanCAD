...
void main() {
  ...
  test('ellipse grips stretch the axes and a half ellipse stays open', () {
    ...
    expect(ellipse.withGrip(0, const Vec2(2, 1)).center, const Vec2(2, 1));
    expect(ellipse.withGrip(1, const Vec2(20, 0)).majorAxis, const Vec2(20, 0));
    expect(ellipse.withGrip(2, const Vec2(-8, 0)).majorAxis, const Vec2(8, 0));
    expect(ellipse.withGrip(3, const Vec2(0, 10)).ratio, closeTo(1, 1e-9));
