...
void main() {
  ...
  test('a synthetic drawing survives DWG save and reopen', () async {
  ...
  test('MULTILEADER and REGION survive a DWG round-trip', () async {
    final document = CadDocument()
      ..addEntity(
        const AttribEntity(id: 1, position: Vec2(6, 6), tag: 'REV', value: 'B'),
      )
      ..addEntity(
        UnknownEntity(
          id: 2,
