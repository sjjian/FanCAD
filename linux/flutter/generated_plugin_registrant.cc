...
void fl_register_plugins(FlPluginRegistry* registry) {
  g_autoptr(FlPluginRegistrar) desktop_open_files_registrar =
      fl_plugin_registry_get_registrar_for_plugin(registry, "OpenFilesPlugin");
  open_files_plugin_register_with_registrar(desktop_open_files_registrar);
