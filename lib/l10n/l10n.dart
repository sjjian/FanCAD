...
extension FanCadL10nLookups on AppLocalizations {
  String commandTitle(String id, String fallback) {
    return switch (id) {
      ...
      'edit.copyClip' => command_edit_copy_clip,
      'edit.copyBase' => command_edit_copy_base,
      'edit.cutClip' => command_edit_cut_clip,
      'edit.pasteClip' => command_edit_paste_clip,
      'edit.pasteOrig' => command_edit_paste_orig,
      'edit.pasteBlock' => command_edit_paste_block,
      ...
      'workbench.preferences' => command_workbench_preferences,
      ...
      'query.selection' => command_query_selection,
      'query.session' => command_query_session,
      'query.viewport' => command_query_viewport,
  ...
  String commandDescription(String id, String fallback) {
    return switch (id) {
      ...
      'query.session' => command_query_session_desc,
  ...
  String importWarningTitle(int count) =>
