...
class DrawCommands {
  ...
  static CommandDescriptor _attdef() => CommandDescriptor(
    id: 'draw.attdef',
    title: 'Attribute Definition',
    category: _category,
    aliases: const ['att', 'attdef'],
    icon: 'text',
    description:
  ...
  static (String?, DimStyleDef?) _dimStyleFromArgs(
    ...
    if (exo < 0 || exe < 0 || gap < 0) {
      return (
        'Extension offset, extend and text gap cannot be negative.',
        null,
      );
    }
    return (
