      ...
      case LineEntity(:final start, :final end, :final length):
        ...
        return [
          ...
          _read(
            context,
            l10n.angle,
            '${_number(delta.angle * 180 / math.pi)}°',
          ),
        ];
      ...
      case ArcEntity(:final center, :final radius):
        return [
          ...
          _read(
            context,
            l10n.start_angle,
            '${_number(entity.startAngle * 180 / math.pi)}°',
          ),
          _read(
            context,
            l10n.end_angle,
            '${_number(entity.endAngle * 180 / math.pi)}°',
          ),
          _read(
            context,
            l10n.total_angle,
            '${_number(entity.sweep * 180 / math.pi)}°',
          ),
        ];
      case PolylineEntity():
        return [
    ...
    return [
      ...
      if (box.isNotEmpty) ...[
        ...
        _read(
          context,
          l10n.size,
          '${_number(box.width)} × ${_number(box.height)}',
        ),
      ],
    ];
  }
