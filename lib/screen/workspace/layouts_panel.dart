...
/// sheet and viewports, but no way to open them from the window.
    ...
    if (tab == null) {
      return Column(
        ...
        children: [
          ...
          Expanded(
            child: FanCadEmpty(message: context.l10n.layouts_empty_workspace),
          ),
        ],
      );
    }
      ...
      children: [
        ...
        Expanded(
          child: layouts.isEmpty
              ? FanCadEmpty(message: context.l10n.layouts_empty_workspace)
              : ListView.builder(
    ...
    showFanCadMenu<String>(
      ...
      items: [
        ...
        if (widget.onRename != null)
          fanCadMenuItem(context, value: 'rename', label: context.l10n.rename),
        if (widget.onCopy != null)
          fanCadMenuItem(context, value: 'copy', label: context.l10n.duplicate),
        if (widget.onDelete != null)
          fanCadMenuItem(context, value: 'delete', label: context.l10n.delete),
        fanCadMenuItem(context, value: 'new', label: context.l10n.new_layout),
      ],
    ).then((action) {
