...
class FanCadTab extends StatefulWidget {
  const FanCadTab({
    super.key,
    required this.selected,
    required this.onTap,
    required this.child,
    this.style = FanCadTabStyle.strip,
    this.height,
    this.padding,
    this.constraints,
    this.tooltip,
  ...
  @override
  State<FanCadTab> createState() => _FanCadTabState();
}

class _FanCadTabState extends State<FanCadTab> {
  bool _hovered = false;
