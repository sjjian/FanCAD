...
class FanCadTextButton extends StatefulWidget {
  const FanCadTextButton({
    super.key,
    required this.label,
    required this.onPressed,
    this.tooltip,
  ...
  @override
  State<FanCadTextButton> createState() => _FanCadTextButtonState();
}

class _FanCadTextButtonState extends State<FanCadTextButton> {
  bool _hovered = false;
    ...
    Widget child = MouseRegion(
      ...
      child: GestureDetector(
        ...
        child: Container(
          height: FanCadTokens.statusBarHeight,
          padding: const EdgeInsets.symmetric(horizontal: FanCadTokens.space2),
          color: widget.enabled && _hovered ? tokens.hover : Colors.transparent,
          alignment: Alignment.center,
          child: Text(
            widget.label,
            style: tokens.labelStyle.copyWith(
