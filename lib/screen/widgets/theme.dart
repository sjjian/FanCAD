...
/// generous padding; a CAD window needs the opposite. Rather than fight the
...
class FanCadTheme {
  ...
  static ThemeData of(FanCadTokens tokens) =>
      _build(tokens, tokens.isDark ? Brightness.dark : Brightness.light);
