...
class PluginEditorPanel extends ConsumerStatefulWidget {
  const PluginEditorPanel({super.key, required this.workspace});
...
class _PluginEditorPanelState extends ConsumerState<PluginEditorPanel> {
              ...
              actions: [
                FanCadIconButton(
                  ...
                  tooltip: _pluginId == null
                      ...
                      : _dirty
                      ? '${context.l10n.save_and_reload}  ${fanCadShortcut('S')}'
                      : context.l10n.saved,
  ...
  Widget _editorBody(
    ...
    if (!available) {
      return FanCadEmpty(message: context.l10n.editor_unavailable);
    }
    if (plugins.isEmpty) {
      return FanCadEmpty(
    ...
    if (_pluginId == null) {
      return FanCadEmpty(message: context.l10n.choose_extension);
    }
    return TextField(
      controller: _body,
      maxLines: null,
